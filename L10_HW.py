...
def apply_color_filter(image, filter_type):
    ...
    if filter_type == "red_tint":
        ...
        filtered_image[:,1,:] = 0
        filtered_image[:,:,1] = 0
    elif filter_type == "gold":
        filtered_image[:,:,0] = 0  
        filtered_image[:,:,1] = cv2.add(filtered_image[:,:,1], 60)  
        filtered_image[:,:,2] = cv2.add(filtered_image[:,:,2], 80)  
